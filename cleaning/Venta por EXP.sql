...
bt_detail as (
    ...
    ELSE 'Others'
                    ...
                    where fh.gestion_date >= DATE('2024-10-01')
        			and fh.gestion_date <= DATE('2024-12-26') -- Excluye hasta donde hubo Expedia
...
----------------------------------------------------
   ...
   with bt_detail as (
             ...
             where fv.recognition_date between date('2024-10-01') and date('2024-12-26')
